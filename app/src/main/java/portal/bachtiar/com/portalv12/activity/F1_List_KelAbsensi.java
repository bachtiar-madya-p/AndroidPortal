...
import portal.bachtiar.com.portalv12.adapter.Adapter_KelAbsensi;
...
public class F1_List_KelAbsensi extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    public static final String TAG = F1_List_KelAbsensi.class.getSimpleName();
    String uri1 = Server.BASE_URL + "absensi/find/nik/";
    String URI, nik;
    public ProgressDialog progressDialog;
    SessionManager session;
    public List<m_KelAbsensi> absensiDataList = new ArrayList<m_KelAbsensi>();
    public ListView listView;
    SwipeRefreshLayout swipe;
    public Adapter_KelAbsensi adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.f1_riwayat_absensi);
        ...
        listView = (ListView) findViewById(R.id.absensiList);
        adapter = new Adapter_KelAbsensi(F1_List_KelAbsensi.this, absensiDataList);
    ...
    private void getData() {
        if (isWorkingInternetPersent()) {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        try {
                            ...
                            m_KelAbsensi sn = new m_KelAbsensi();
            ...
            showAlertDialog(F1_List_KelAbsensi.this, "Internet Connection",
    ...
    public void onBackPressed() {
        Intent a = new Intent(F1_List_KelAbsensi.this, MainActivity.class);

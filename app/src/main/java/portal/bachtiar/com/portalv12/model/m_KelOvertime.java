...
public class m_KelOvertime {
     ...
     * @param nik
     */
    public m_KelOvertime(String content, String date, String status, Integer id, String dept, String email, String imgUser, String name, Integer nik, String phone,

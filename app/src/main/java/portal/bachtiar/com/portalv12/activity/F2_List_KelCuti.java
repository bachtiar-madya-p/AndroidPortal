...
import portal.bachtiar.com.portalv12.adapter.Adapter_KelCuti;
...
public class F2_List_KelCuti extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {

    public static final String TAG = F2_List_KelCuti.class.getSimpleName();
    String uri1 = Server.BASE_URL + "cuti/find/nik/";
    String URI, nik;
    public ProgressDialog progressDialog;
    SessionManager session;
    public List<m_KelCuti> cutiDataList = new ArrayList<m_KelCuti>();
    public ListView listView;
    SwipeRefreshLayout swipe;
    public Adapter_KelCuti adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter_KelCuti(F2_List_KelCuti.this, cutiDataList);
    ...
    private void getData() {
        if (isWorkingInternetPersent()) {
            ...
            showAlertDialog(F2_List_KelCuti.this, "Internet Connection",
    ...
    public void onBackPressed() {
        Intent a = new Intent(F2_List_KelCuti.this, MainActivity.class);

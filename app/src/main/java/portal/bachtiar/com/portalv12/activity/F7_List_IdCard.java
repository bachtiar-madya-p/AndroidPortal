...
import portal.bachtiar.com.portalv12.adapter.Adapter_IdCard;
...
public class F7_List_IdCard extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    public static final String TAG = F7_List_IdCard.class.getSimpleName();
    String uri1 = Server.BASE_URL + "idcard/find/nik/";
    String URI, nik;
    public ProgressDialog progressDialog;
    SessionManager session;
    public List<m_IdCard> idCardDataList = new ArrayList<m_IdCard>();
    public ListView listView;
    SwipeRefreshLayout swipe;
    public Adapter_IdCard adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapter_IdCard(F7_List_IdCard.this, idCardDataList);
    ...
    private void callVolley() {
        if (isWorkingInternetPersent()) {
            ...
            showAlertDialog(F7_List_IdCard.this, "Internet Connection",
    ...
    public void onBackPressed() {
        Intent a = new Intent(F7_List_IdCard.this, MainActivity.class);
